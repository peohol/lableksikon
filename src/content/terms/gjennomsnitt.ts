...
export const gjennomsnitt: PublishedTerm = {
  ...
  depth: {
    ...
    blocks: [
      { kind: "p", text: "Et utvalgsgjennomsnitt \\(\\bar{x}\\) brukes ofte til å estimere en ukjent populasjonsmiddelverdi \\(\\mu\\). Hvor presist estimatet er, avhenger blant annet av antall observasjoner og spredningen i dataene." },
