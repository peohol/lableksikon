...
export const vektet: PublishedTerm = {
  ...
  explanation: [
    ...
    { kind: "p", text: "Vekter som \\(1/x\\) eller \\(1/x^2\\) brukes ofte, men de er modellvalg og ikke standardfasit. Valget bør bygge på hvordan variansen faktisk endrer seg, og på hvordan modellen presterer i hele [arbeidsområdet](begrep:arbeidsomrade)." },
  ],
  ...
  depth: {
    ...
    blocks: [
      ...
      { kind: "p", text: "I praksis estimeres vektene. Dårlige estimater eller et tilfeldig valg mellom \\(1/x\\) og \\(1/x^2\\) kan forverre modellen. Residualer og tilbakeberegnede kalibratorer bør undersøkes gjennom hele området." },
