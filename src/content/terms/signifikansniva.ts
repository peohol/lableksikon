...
export const signifikansniva: PublishedTerm = {
  ...
  depth: {
    ...
    blocks: [
      ...
      { kind: "p", text: "Valg av α bør derfor skilles fra vurdering av effektstørrelse, [konfidensintervall](begrep:konfidensintervall), måleusikkerhet og faglige beslutningsgrenser." },
