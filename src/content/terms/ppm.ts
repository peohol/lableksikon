...
export const ppm: PublishedTerm = {
  ...
  title: "ppm",
  category: "enheter",
  definition: "«Parts per million»: en måte å uttrykke en dimensjonsløs relativ verdi på, der 1 ppm betyr 10⁻⁶, altså én del per million.",
  aliases: ["parts per million", "10^-6", "10⁻⁶", "mg/kg", "µmol/mol", "deler per million"],
  explanation: [
    { kind: "p", text: "ppm sier hvor stor en brøk er, men ikke hvilken type brøk. For en massefraksjon er 1 mg/kg = 1 ppm; for en stoffmengdefraksjon er 1 µmol/mol = 1 ppm." },
  ...
  depth: {
    ...
    blocks: [
      { kind: "p", text: "BIPM beskriver ppm som 10⁻⁶ relativ verdi, analogt med at prosent betyr deler per hundre. Det er derfor tryggere å skrive både størrelsen og enheten, for eksempel massefraksjon 2 mg/kg, enn å bruke ppm alene når sammenhengen kan være tvetydig." },
