...
export const utvidet: PublishedTerm = {
  ...
  explanation: [
    ...
    { kind: "p", text: "Resultatet kan for eksempel uttrykkes som 100 ± 3 når U = 3. Hvilken dekning dette svarer til, må oppgis eller kunne utledes fra hvordan k er valgt." },
  ],
  demo: "utvidet-intervall",
  depth: {
    title: "Dybde: U = k · uᶜ og hvorfor k = 2 ikke er magisk",
    blocks: [
