...
export const masseopplosning: PublishedTerm = {
  ...
  category: "deteksjon",
  definition: "Et massespektrometers evne til å skille ionetoppsignaler med nærliggende masse-til-ladning-forhold; numerisk beskrives dette ofte med resolving power.",
  ...
  explanation: [
    ...
    { kind: "p", text: "I norsk laboratoriebruk brukes «masseoppløsning» ofte om det IUPAC kaller resolving power. Når en numerisk verdi oppgis som \\(m/\\Delta m\\), må kriteriet for \\(\\Delta m\\) følge med; det kan for eksempel bygge på toppbredde ved en angitt høyde eller en angitt dal mellom to topper." },
  ],
  demo: "masseopplosning-topper",
  depth: {
    title: "Dybde: resolution og resolving power må defineres",
    blocks: [
      { kind: "p", text: "IUPAC beskriver flere konvensjoner. Et tall som 60 000 er derfor ikke fullstendig spesifisert uten å vite \\(m/z\\) og hvordan \\(\\Delta m\\) er definert. Sammenligning mellom instrumenter krever samme konvensjon." },
