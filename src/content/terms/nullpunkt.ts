...
export const nullpunkt: PublishedTerm = {
  ...
  definition: "I en lineær kalibreringsmodell y = a + bx er konstantleddet a den forventede responsen når analyttverdien x er null.",
  aliases: ["intercept", "y-intercept", "konstantledd", "skjæringspunkt", "nullpunkt", "blankrespons"],
  explanation: [
    { kind: "p", text: "Når x = 0, står bare a igjen i modellen. Et ikke-null konstantledd kan gjenspeile bakgrunnssignal, blankbidrag eller andre systematiske trekk ved målesystemet, men kan også være påvirket av tilfeldig variasjon i kalibreringsdataene." },
    { kind: "p", text: "Ordet «nullpunkt» er tvetydig: i matematikk betyr det ofte x-verdien der y = 0. I kalibreringssammenheng brukes det noen ganger om responsen ved x = 0. Derfor er «konstantledd» eller «skjæring med responsaksen» mer presist." },
  ],
