...
export const reproduserbarhet: PublishedTerm = {
  ...
  explanation: [
    { kind: "p", text: "Når flere laboratorier analyserer sammenlignbart materiale med samme overordnede måleprosedyre, får vi et mål på hvor godt resultatene stemmer overens på tvers av steder." },
  ...
  depth: {
    ...
    blocks: [
      { kind: "p", text: "VIM knytter reproduserbarhet til presisjon under betingelser med ulike steder, operatører og målesystemer. Betingelsene og forsøksdesignet må beskrives for at et reproduserbarhetsestimat skal kunne tolkes." },
  ...
  sources: [SOURCES.vimReproducibility, SOURCES.eurachem2025],
  status: "publisert",
};
