...
export const massespektrometri: PublishedTerm = {
  ...
  category: "deteksjon",
  definition: "Analyse av gassfaseioner ved å skille eller karakterisere dem etter masse-til-ladning-forholdet m/z og registrere ionenes intensitet.",
  ...
  depth: {
    ...
    blocks: [
      ...
      { kind: "p", text: "I tandem-massespektrometri kan bestemte ioner velges, [fragmenteres](begrep:fragmentering) og produktionene analyseres videre. Dette gir mer struktur- og identitetsinformasjon enn et enkelt m/z-signal alene." },
    ],
  },
