...
export function SeparasjonsfaktorDemo() {
  return <DemonstrationFrame kind="formel" instruction="Sammenlign justert retensjon for to nabotopper." label="Separasjonsfaktor \\(\\alpha\\) er et forhold" afterword="\(\alpha\) beskriver retensjonsforskjell, ikke hele oppløsningen."><Rows rows={[{label:"\\(k_1\\)",value:"2,0"},{label:"\\(k_2\\)",value:"2,4"},{label:"\\(\\alpha = k_2/k_1\\)",value:"1,20"}]} /></DemonstrationFrame>;
}
