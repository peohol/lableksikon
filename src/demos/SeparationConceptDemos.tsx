...
export function InjeksjonsvolumDemo() {
  return <DemonstrationFrame kind="sammenligning" instruction="Se avveiningen når injeksjonen økes." label="Større injeksjon kan gi mer analytt — og bredere bånd" afterword="Riktig volum bestemmes av hele metoden og kontrolleres mot systemegnethet."><Rows rows={[{label:"Liten injeksjon",value:"mindre prøveplugg"},{label:"Stor injeksjon",value:"mer analytt, større risiko for båndspredning"},{label:"Krav",value:"oppløsning og linearitet må fortsatt være tilfredsstillende"}]} /></DemonstrationFrame>;
}